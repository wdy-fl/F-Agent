...
2. **技能管理工具**
   - `tools/skill.py`：skills_list / skill_view / skill_manage 三个工具
   - 支持 create / edit / delete / write_file / remove_file 操作
   - 变更需重启会话生效

**交付标准**：阿福能从经验中主动提议创建技能（需用户确认），技能通过渐进式披露在对话中复用。
